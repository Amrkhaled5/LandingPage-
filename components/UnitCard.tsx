    ...
    <>
      ...
      <article className="flex h-full flex-col rounded-2xl border border-[#E5D9C5] bg-[#FEFBF3] shadow-md transition-all duration-300 hover:shadow-xl overflow-hidden">
        ...
        <div className="flex flex-col flex-1 p-5 gap-4">
          ...
          {/* CTA row — WhatsApp + Call */}
          <div className="mt-auto flex gap-2">
            <a
              href={waHref}
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-green-500 py-3 text-sm font-bold text-white transition-colors hover:bg-green-600"
            >
              {WA_ICON}
              واتساب
            </a>
            <a
              ...
              aria-label="اتصل بنا"
              className="flex items-center justify-center rounded-xl bg-[#1B2A3B] px-4 py-3 text-white transition-colors hover:bg-[#243547]"
            >
              {PHONE_ICON}
            </a>
          </div>
