    ...
    <>
      ...
      <div className="fixed bottom-6 left-6 z-50 flex flex-col gap-3">
        ...
        <a
          ...
          className="flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg transition-transform hover:scale-110"
        >
        ...
        <a
          ...
          aria-label="اتصل بنا"
          className="flex h-14 w-14 items-center justify-center rounded-full bg-[#1B2A3B] shadow-lg transition-transform hover:scale-110"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="h-7 w-7">
        ...
        <a
          ...
          className="flex h-14 w-14 items-center justify-center rounded-full bg-[#1877F2] shadow-lg transition-transform hover:scale-110"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="h-7 w-7">
